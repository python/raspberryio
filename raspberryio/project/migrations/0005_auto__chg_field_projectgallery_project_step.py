...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectGallery.project_step'
        db.alter_column('project_projectgallery', 'project_step_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['project.ProjectStep']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectGallery.project_step'
        raise RuntimeError("Cannot reverse this migration. 'ProjectGallery.project_step' and its values cannot be restored.")
    ...
    models = {
        ...
        'project.projectgallery': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project_step': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'project_gallery'", 'null': 'True', 'to': "orm['project.ProjectStep']"})
        },
